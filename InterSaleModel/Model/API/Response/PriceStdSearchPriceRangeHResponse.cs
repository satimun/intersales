...
namespace InterSaleModel.Model.API.Response
{
    ...
    public class PriceStdSearchPriceRangeHResponse : IResponseModel
    {
        public List<PriceStdRangeHs> priceStdRangeHs = new List<PriceStdRangeHs>();
    }
}

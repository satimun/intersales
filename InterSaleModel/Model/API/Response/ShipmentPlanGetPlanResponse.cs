...
using System.Text;
using static InterSaleModel.Model.API.Response.ShipmentPlanGetPlanResponse.ShipmentPlanMain.ShipmentPlanOrderStand;

namespace InterSaleModel.Model.API.Response
{
    public class ShipmentPlanGetPlanResponse : IResponseModel
    {

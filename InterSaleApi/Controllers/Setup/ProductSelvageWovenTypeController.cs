...
namespace InterSaleApi.Controllers.Setup
{
    ...
    [Route("v1/api/ProductSelvageWovenType")]
    public class ProductSelvageWovenTypeController : Controller
    {
        ...
        {
            ProductSelvageWovenTypeSearchAPI res = new ProductSelvageWovenTypeSearchAPI();
